...
export default function ReferralReportPage() {
  ...
  const exportUserStats = () => {
    ...
    const headers = ['User ID', 'User Name', 'User Email', 'Total Referral Bonus', 'Referral Count'];
        ...
        <>
          ...
          {report.userStats.length > 0 && (
            <div className="bg-white rounded-lg shadow p-6 mb-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold text-gray-900">User Referral Statistics</h3>
                <button
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
              <h3 className="text-lg font-semibold text-gray-900">Referral Transactions ({report.transactions.length})</h3>
