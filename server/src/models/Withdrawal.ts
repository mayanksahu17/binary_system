...
export interface IWithdrawal extends Document {
  ...
  cryptoType?: string;
  walletType: "roi"|"interest"|"withdrawal"|"career_level"|"referral"|"binary";
...
const WithdrawalSchema = new Schema<IWithdrawal>({
  ...
  walletType: { type: String, enum: ["roi","interest","withdrawal","career_level","referral","binary"], required: true },
